...
import static it.fdg.lm190925web.cFileSystem.mPrefs5;
import static it.fdg.lm190925web.cFunk.mArrayRedim;
import static it.fdg.lm190925web.cFunk.mInt2str;
import static it.fdg.lm190925web.cFunk.mLimit;
import static it.fdg.lm190925web.cFunk.mStr2Int;
import static it.fdg.lm190925web.cProgram3.bDesignMode;
import static it.fdg.lm190925web.cProgram3.bDoRedraw;
import static it.fdg.lm190925web.cProgram3.mErrMsg;
import static it.fdg.lm190925web.cProgram3.oFocusdActivity;
...
public  class cElemViewProps {
    ...
    public void mZoom(float scalePointX, float scalePointY, float nFactor) {    //171003 implementing zoom
        ...
        if (newB>20)
            newB=round(newB/5)*5;
        if (myProtElem().nDisplayRange[0]!=0) myProtElem().nDisplayRange[0]=newA;
    ...
    public void mChangeValue(float nChange) {   //Change the value with a fraction of the scale
            myProtElem().mChangeValue(_ElemDataIdx, nChange);
    }
    ...
    private void _mElemBinding(boolean bGetIt, String sKey) {
        //In the lm_config file in format example    WV0A0.Name	=>	[P1,IMin, 0, 3];
